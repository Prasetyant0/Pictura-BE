            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="items-center justify-between hidden w-full lg:flex md:w-auto" id="navbar-sticky">
                    <ul
                        ...
                        <li>
                            <a href="#" class="block py-2 px-5 text-center me-2 text-gray-900 rounded-full bg-transparent
                        hover:bg-secondary hover:text-white
                    ...
                    <div class="flex items-center justify-center w-1/2">
                        <label for="dropzone-file"
                            ...
                            <div id="preview-container" class="hidden">
                                <img id="preview-image" class="rounded-20 max-h-[300px] object-contain"
                                    alt="Preview Image">
                            </div>
